...
const EMAIL    = 'candidaturaforum@gmail.com'
const WA_URL   = 'https://wa.me/393292412021'
const WA_CH    = 'https://whatsapp.com/channel/0029VbAeczMJUM2RgxolNg1n'
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          ...
          >
            ...
            <div>
              ...
              <div className="text-white text-sm font-medium">+39 329 241 2021</div>
            </div>
          </a>
        </div>

        {/* ── Banner canale WhatsApp Comune ── */}
        <a
          href={WA_CH}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-between gap-6 p-6 rounded-2xl border border-green-500/25 transition-all duration-200 group"
        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="text-white font-semibold text-sm">Entra nel canale WhatsApp del Comune di Lacedonia</div>
              <div className="text-gray-500 text-xs mt-0.5">Resta aggiornato su tutte le novità del Forum</div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <address className="text-gray-600 text-xs not-italic">
            Sede: Piazza Municipio 1 — 83046 Lacedonia (AV)
          </address>
        </div>
